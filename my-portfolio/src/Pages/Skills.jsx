...
export default function Skills() {
  ...
  <div className='Core-D'>
      <div className='Core'>
       <h2 className='Cr-L'>Core Languages</h2>
       <div className='btn-l'>
  ...
  <div className='App-I'>
      ...
      <div className='app'>
        <h2 className='Ap-ar'>API Architecture</h2>

        <div className='Ap-li'>
       <ul>
        <li>RESTfulRESTful</li>
        <li>GraphQL</li>
       </ul>
        </div>
      ...
      <div className='inf'>
         <h2 className='Inf-clo'>Cloud & Infrastructure</h2>
